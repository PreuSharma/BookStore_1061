...
import { signupApiCall } from "../../utility/User";
...
const Signup: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-300">
      <div className="flex bg-white shadow-lg ro5unded-lg overflow-hidden w-3/7">
        {/* Left Side */}
        ...
        {/* Right Side */}
        <div className="w-1/4 p-15 absolute top-[-60px] left-[50%] transform -translate-x-1/2 bg-white shadow-lg z-10 mt-56 ml-40 h-125 min-h-[250px] flex flex-col justify-center   bg-white shadow-lg rounded-lg ">
